...
a persistence unit "test-1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "test-1\pom.xml":
...
artifact ("test-1.war") is already built. You can build
